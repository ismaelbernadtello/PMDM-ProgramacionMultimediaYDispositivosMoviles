...
public class AutorPremioController implements Serializable {
    ...
    public AutorPremio getSelected() {
        if (current == null) {
            ...
            current.setAutorPremioPK(new EntidadesOModelos.AutorPremioPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public AutorPremio getAutorPremio(EntidadesOModelos.AutorPremioPK id) {
    ...
    public static class AutorPremioControllerConverter implements Converter {
        ...
        EntidadesOModelos.AutorPremioPK getKey(String value) {
            EntidadesOModelos.AutorPremioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new EntidadesOModelos.AutorPremioPK();
        ...
        String getStringKey(EntidadesOModelos.AutorPremioPK value) {
